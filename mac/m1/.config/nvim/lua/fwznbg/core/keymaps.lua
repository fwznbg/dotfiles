...
keymap.set("n", "<C-Tab>", "<cmd>BufferLineCycleNext<CR>", { desc = "Move to the next bufferline" })
keymap.set("n", "<C-S-Tab>", "<cmd>BufferLineCyclePrev<CR>", { desc = "Move to the previous bufferline" })
